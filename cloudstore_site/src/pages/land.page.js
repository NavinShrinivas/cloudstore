               ...
               <div className="ms-4 me-3 my-5">
                  ...
                  <div className="d-flex flex-column">
                     <div className="p" style={{ fontSize: '1.1rem', textAlign: 'justify' }}>
                        This is an simple minimal e-commerce application implemented by PK Navin Shrinivas, Mohammed Ayaan, Mukund Deepak and Mitul Joby as a part of UE20CS351 - Cloud Computing. Welcome HIII!
                     </div>
                  </div>
